    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            void CreateTable()
            {
                ...
                {
                    xlSheet.Cells[1, 1+i] = fejlécek[0+i];
                }
                ...
                Excel.Range oszlopRange = xlSheet.get_Range("A2", Type.Missing).get_Resize(sorokSzáma, 1);
                oszlopRange.Interior.Color = Color.LightYellow;
                oszlopRange.Font.Bold = true;

                Excel.Range oszlopRange2 = xlSheet.get_Range("F2", Type.Missing).get_Resize(sorokSzáma, 1);
                oszlopRange2.Interior.Color = Color.LightGreen;
